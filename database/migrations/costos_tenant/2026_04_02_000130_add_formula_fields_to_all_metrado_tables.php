...
return new class extends Migration
{
    ...
    {
        $tables = [
            'metrado_arquitectura_modulos',
            'metrado_arquitectura_exterior',
            'metrado_arquitectura_cisterna',
            'metrado_estructura_modulos',
            'metrado_estructura_exterior',
            'metrado_estructura_cisterna',
            'metrado_electricas',
