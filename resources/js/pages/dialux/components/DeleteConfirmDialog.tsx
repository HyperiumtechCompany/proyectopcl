...
export const DeleteConfirmDialog: React.FC<DeleteConfirmDialogProps> = ({
    ...
    return (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
            <div className="w-full max-w-md rounded-2xl border border-red-700/40 bg-slate-900 p-5 shadow-2xl">
                ...
                {analysis.children.length > 0 && (
                    <div className="mb-4 space-y-1 rounded-xl border border-slate-700 bg-slate-950/60 p-3 text-xs text-slate-300">
