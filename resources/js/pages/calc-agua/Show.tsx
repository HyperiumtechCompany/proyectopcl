...
export default function Show() {
    ...
    const renderTabContent = () => {
        ...
        switch (activeTab) {
            ...
            case 'redAlimentacion': return <RedAlimentacion {...props} />;
            case 'maximademandasimultanea': return <MaximaDemandaSimultanea {...props} />;
            case 'bombeoTanqueElevado': return <BombeoTanqueElevado {...props} />;
            case 'tuberiasRD': return <TuberiasRD {...props} />;
            case 'redesInteriores': return <RedesInteriores {...props} />;
            case 'redRiego': return <RedRiego {...props} />;
            default: return null;
        }
    };
