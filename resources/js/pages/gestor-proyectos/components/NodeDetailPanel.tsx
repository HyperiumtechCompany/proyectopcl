...
import { COLORS, STATUS_DOT, TYPE_ICON } from './types';
...
export function NodeDetailPanel({ selected, isRoot, selectedChildrenLabel, onClose, onSelectChild, onRequestAddChild, onRequestEdit, onRequestDelete }: NodeDetailPanelProps) {
    ...
    return (
        <div className="absolute right-0 top-0 h-full w-80 overflow-y-auto border-l border-white/10 bg-[#101218] p-4 shadow-2xl">
            <div className="mb-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button
                        ...
                        title={isRoot ? 'El nodo raíz no se puede eliminar' : 'Eliminar nodo'}>
                        <Trash2 size={15} />
                    </button>
