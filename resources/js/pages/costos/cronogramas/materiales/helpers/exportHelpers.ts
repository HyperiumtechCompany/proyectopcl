...
/** Agrupa materiales por campo `tipo` manteniendo el orden canÃ³nico */
...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// BUILDER: encabezado del reporte (filas 1-5)
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function buildReportHeader(
    ...
    const merge = (r: number, label: string, style: Partial<ExcelJS.Style>) => {
        ws.mergeCells(r, actualCol(1), r, actualLastCol(totalCols));
        const cell = ws.getCell(r, actualCol(1));
        cell.value = label;
        cell.style = style;
        ws.getRow(r).height = r === 1 ? 24 : 16;
    };

    merge(1, 'CRONOGRAMA DE ' + tipoLabel, {
    ...
    merge(3, `Generado: ${new Date().toLocaleString('es-PE', { dateStyle: 'medium', timeStyle: 'short' })}`, {
        font:      mkFont({ size: 8, color: { argb: 'FF94A3B8' } }),
        alignment: mkAlign('left'),
    });
    merge(4,
        viewMode === 'cantidad'
            ? 'MODO ACTIVO: CANTIDADES'
            : 'MODO ACTIVO: MONTOS (S/.)',
        {
            font:  mkFont({ size: 8, bold: true, color: { argb: 'FF475569' } }),
            fill:  mkFill('FFF3F4F6'),
            alignment: mkAlign('left'),
            border: mkBorder('FFCBD5E1'),
        },
...
function buildResumenSheet(
    ...
    const datos: Array<[string, ExcelJS.CellValue, string?]> = [
        ...
        ['Duracion del proyecto', `${periodos.length} mes${periodos.length !== 1 ? 'es' : ''}`],
...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// FUNCIÃ“N PRINCIPAL EXPORTADORA
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
/**
 ...
 * @param periodos          PerÃ­odos del proyecto
 * @param projectName       Nombre del proyecto
 * @param viewMode          'cantidad' | 'monto'
 * @param tipoFiltroActivo  Filtro activo:
 *                            - undefined / '' â†’ exporta TODO agrupado por tipo
 *                            - 'mano_de_obra' | 'materiales' | 'equipos' | etc.
 *                              â†’ exporta solo ese tipo (sheet con ese nombre)
 */
export const exportarMaterialesExcel = async (
    ...
    // â”€â”€ Columnas fijas: #, Tipo, Partida, DescripciÃ³n, UND, Precio
    const COL_FIXED = 6;
    // Total columnas = fijas + 2 por perÃ­odo + 2 totales
    const TOTAL_COLS = COL_FIXED + periodos.length * 2 + 2;

    // â”€â”€ Crear workbook
    const wb = new ExcelJS.Workbook();
    wb.creator        = 'PCL â€” Cronograma Materiales';
    ...
    const ws = wb.addWorksheet(sheetName, {
        ...
        headerFooter: {
            oddHeader: `&L&B${projectName}&C&BTipo: ${tipoLabel}&R&BPÃ¡gina &P de &N`,
            oddFooter: `&LGenerado: ${new Date().toLocaleString('es-PE')}&RPor: PCL`,
        },
        properties: { tabColor: { argb: filtroEsTodo ? 'FFE5E7EB' : getTipoMeta(tipoFiltroActivo!).headerArgb } },
    });

    setupCronogramaColumns(ws, periodos, COL_FIXED);

    // â”€â”€ Encabezado reporte (filas 1-4)
    buildReportHeader(ws, projectName, tipoLabel, viewMode, TOTAL_COLS);

    // â”€â”€ Encabezados de columna (filas 6-7)
    buildColumnHeaders(ws, periodos, viewMode, mesPicoKey, 6, COL_FIXED);
    ...
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    buildResumenSheet(wb, materiales, periodos, projectName, tipoLabel, mesPicoKey);

    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // SI ES "TODO": hojas adicionales por tipo (para navegaciÃ³n rÃ¡pida)
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (filtroEsTodo) {
        const grupos = agruparPorTipo(materiales);
        ...
        grupos.forEach((items, tipo) => {
            ...
            buildReportHeader(wsT, projectName, meta.label, viewMode, TOTAL_COLS);
            buildColumnHeaders(wsT, periodos, viewMode, mesPicoKey, 6, COL_FIXED);
    ...
    const nombre   = `Cronograma_${sufijo}_${projectName.replace(/\s+/g, '_')}_${fecha}.xlsx`;
