// ═══════════════════════════════════════════════════════════════
// ImportarMetradoEstructurasModal.tsx
// Modal para importar metrados de estructuras desde un archivo Excel
// ═══════════════════════════════════════════════════════════════
...
import { toRoman } from './estructuras_utils';
...
export interface ImportarMetradoEstructurasModalProps {
    open:             boolean;
    moduleCount:      number;
...
export function ImportarMetradoEstructurasModal({
    open,
    moduleCount,
    activeSheetName,
    onClose,
    onImport,
}: ImportarMetradoEstructurasModalProps) {
            ...
            <div className="flex w-full max-w-5xl flex-col overflow-hidden rounded-xl border border-slate-700 bg-slate-900 shadow-2xl max-h-[92vh]">
                ...
                <div className="flex items-center justify-between border-b border-slate-700/50 bg-slate-800/70 px-5 py-3.5">
                    <h3 className="flex items-center gap-2 text-[13px] font-bold text-slate-100">
                        ...
                        Importar Metrado Estructuras desde Excel
                    </h3>
                    <button
                        onClick={handleClose}
                                ...
                                >
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="mt-0.5 text-[11px] text-slate-500">
                                            Archivos .xlsx y .xls · Formato Metrado de Estructuras
                                        </p>
                                    </div>
                                    <input
                                        type="file"
                                    ...
                                    <table className="text-[9px]">
                                        ...
                                        <tbody>
                                            <tr className="text-violet-400 font-semibold">
                                                ...
                                                <td className="border border-slate-700/50 px-2 py-1">ESTRUCTURAS</td>
