// ═══════════════════════════════════════════════════
// arquitectura_NumberingModal.tsx — Numeración jerárquica
// ═══════════════════════════════════════════════════
...
import { LEAF_STYLE, LEVEL_PALETTE, MAX_LEVELS } from './arquitectura_constants';
import { mkTxt, pad2, r4, readRow, rowMeta, toNum, trim0 } from './arquitectura_utils';
import type { RowKind } from './arquitectura_types';
import { ALL_COLS, CI } from './arquitectura_constants';
import { levelStyle } from './arquitectura_utils';
...
export function NumberingModal({ open, onClose, onApply }: NumberingModalProps) {
  const [baseStr, setBaseStr] = useState('2'); // Por defecto para arquitectura suele ser 1 o 2
