...
import {ALL_INPUTS,DEFAULT_PROFILE,INPUT_LABELS,OUTPUT_LABELS,UNITS,UNIT_PROFILES} from './electricas_constants';
import type { CalcPayload, MeasureInputs, MeasureOutputs, UnitProfile } from './electricas_types';
