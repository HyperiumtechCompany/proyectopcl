// ═══════════════════════════════════════════════════════════════
// ImportarMetradoElectricasModal.tsx
// Modal para importar metrados de eléctricas desde un archivo Excel
// ═══════════════════════════════════════════════════════════════
...
import { toRoman } from './electricas_utils';
...
export interface ImportarMetradoElectricasModalProps {
    open:             boolean;
    moduleCount:      number;
...
export function ImportarMetradoElectricasModal({
    open,
    moduleCount,
    activeSheetName,
    onClose,
    onImport,
}: ImportarMetradoElectricasModalProps) {
            ...
            <div className="flex w-full max-w-5xl flex-col overflow-hidden rounded-xl border border-slate-700 bg-slate-900 shadow-2xl max-h-[92vh]">
                ...
                <div className="flex items-center justify-between border-b border-slate-700/50 bg-slate-800/70 px-5 py-3.5">
                    <h3 className="flex items-center gap-2 text-[13px] font-bold text-slate-100">
                        ...
                        Importar Metrados Eléctricas desde Excel
                    </h3>
                    <button
                        onClick={handleClose}
