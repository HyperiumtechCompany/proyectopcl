import type { UnitProfile } from './electricas_types';
...
// ═══════════════════════════════════════════════════════════════
// PERFILES DE UNIDAD — TODAS LAS VERSIONES DISTINTAS
// ═══════════════════════════════════════════════════════════════
export const UNIT_PROFILES: Record<string, UnitProfile[]> = {
  ...
  // ─────────────────────────────────────────────────────────────
  // METROS LINEALES (m, ml) — 4 versiones
  // ─────────────────────────────────────────────────────────────
  m: [
    {
      key: 'm_v1',
  ...
  // ─────────────────────────────────────────────────────────────
  // METROS LINEALES (ml) — MISMAS que 'm'
  // ─────────────────────────────────────────────────────────────
  ml: [
    {
      key: 'ml_v1',
