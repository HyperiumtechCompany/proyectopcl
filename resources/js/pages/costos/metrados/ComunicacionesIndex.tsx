...
import { ImportarMetradoComunicacionesModal, type ImportedMetradoRow } from './metradocomunicaciones/ImportarMetradoComunicacionesModal';
...
export default function comunicacionesIndex() {
  ...
  const handleExportarExcel = useCallback(async () => {
    try {
      ...
      await exportarMetradoExcelMultiSheet('comunicaciones', sheetsData, proyectoExport);
  ...
  return (
    ...
    transition-all hover:bg-emerald-700 active:scale-95"
      ...
      <ImportarMetradoComunicacionesModal
        open={importOpen}
