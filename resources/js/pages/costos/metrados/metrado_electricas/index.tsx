...
export default function Index() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Electricas', href: electricasRoutes.index.url() },
    ];

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            {/* copiar la estructura de Caída de tensión con adaptaciones */}
            {/* ... similar markup a CaidaTension/Index.tsx ... */}
            <div className="w-full rounded-lg bg-white px-12 py-6 shadow dark:bg-gray-900">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">Hojas de Electricas</h1>
                ...
                {!spreadsheets || spreadsheets.length === 0 ? (
                    <div className="rounded-lg border border-dashed border-gray-300 bg-white py-16 text-center dark:border-gray-700 dark:bg-gray-900">
                        <p className="mb-3 text-sm text-gray-500 dark:text-gray-400">No tienes hojas creadas todavía.</p>
                        <button
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
                        {spreadsheets.map((sheet) => (
                            <div key={sheet.id} className="group cursor-pointer rounded-lg border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-gray-700 dark:bg-gray-800" onClick={() => router.get(electricasRoutes.show.url(sheet.id))}>
                                <div className="p-4">
                ...
                {showCreate && (
                    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                        <div className="mx-4 w-full max-w-sm rounded-xl bg-white p-6 shadow-xl dark:bg-gray-900 dark:ring-1 dark:ring-gray-700">
                            <h2 className="mb-4 text-base font-bold text-gray-800 dark:text-gray-100">Nueva Hoja de Electricas</h2>
                            <form onSubmit={handleCreate} className="space-y-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Ej: Metrado Electricas - Edificio A"
