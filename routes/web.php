...
use App\Http\Controllers\ControlAvanceObraController;
use App\Http\Controllers\ControlAvanFisicoController;
use App\Http\Controllers\ControlFinancieroController;
use App\Http\Controllers\CostoModuleController;
use App\Http\Controllers\CostoProjectController;
use App\Http\Controllers\CronoEjecutadoController;
...
use App\Http\Controllers\PagosValorizacionController;
use App\Http\Controllers\PlanRequestController;
use App\Http\Controllers\PresupuestoController;
use App\Http\Controllers\ProgVsEjecController;
use App\Http\Controllers\ResumenValController;
use App\Http\Controllers\RFCController;
use App\Http\Controllers\RhEmController;
...
Route::middleware(['auth', 'verified', SetCostosDatabase::class])->group(function () {
    ...
    Route::get('/module/crono_ejecutado', [CronoEjecutadoController::class, 'index'])->name('proyectos.cronograma.ejecutado');
    Route::post('/module/crono_ejecutado/save', [CronoEjecutadoController::class, 'store'])->name('proyectos.cronograma.ejecutado.save');
    Route::get('/module/control_avance_obra', [ControlAvanceObraController::class, 'index'])->name('proyectos.cronograma.control_avance');
    Route::get('/module/prog_vs_ejec', [ProgVsEjecController::class, 'index'])->name('proyectos.cronograma.prog_vs_ejec');
    Route::get('/module/curva_s', [CurvaSController::class, 'index'])->name('proyectos.cronograma.curva_s');
    Route::get('/module/control_avan_fisico', [ControlAvanFisicoController::class, 'index'])->name('proyectos.cronograma.control_avan_fisico');
    Route::get('/module/adelantos', [AdelantosController::class, 'index'])->name('proyectos.cronograma.adelantos');
    Route::post('/module/adelantos/save', [AdelantosController::class, 'store'])->name('proyectos.cronograma.adelantos.save');
    Route::get('/module/rfc', [RFCController::class, 'index'])->name('proyectos.cronograma.rfc');
    Route::get('/module/resumen_val', [ResumenValController::class, 'index'])->name('proyectos.cronograma.resumen_val');
    Route::get('/module/control_financiero', [ControlFinancieroController::class, 'index'])->name('proyectos.cronograma.control_financiero');
    Route::get('/module/r_pago_mensual', [PagosValorizacionController::class, 'mensual'])->name('proyectos.cronograma.r_pago_mensual');
    Route::get('/module/pagos_acumulados', [PagosValorizacionController::class, 'acumulados'])->name('proyectos.cronograma.pagos_acumulados');
    Route::get('/module/control_pagos', [PagosValorizacionController::class, 'control'])->name('proyectos.cronograma.control_pagos');
    Route::post('/module/control_pagos/save', [PagosValorizacionController::class, 'store'])->name('proyectos.cronograma.control_pagos.save');
    Route::get('/module/rh_em', [RhEmController::class, 'index'])->name('proyectos.cronograma.rh_em');
    Route::post('/module/rh_em/save', [RhEmController::class, 'store'])->name('proyectos.cronograma.rh_em.save');
    Route::post('/module/control_financiero/toggle-devengado', [ControlFinancieroController::class, 'toggleDevengado'])->name('proyectos.cronograma.control_financiero.toggle_devengado');
    ...
    Route::post('/module/crono_valorizado/inicio-real-campo', [CronoValorizadoController::class, 'saveInicioRealCampo'])->name('proyectos.cronograma.valorizado.inicio_real_campo');
    ...
    Route::get('/cronograma/v2/{project}/snapshots', [CronogramaV2Controller::class, 'snapshots'])->name('proyectos.cronograma.v2.snapshots');
    Route::post('/cronograma/v2/{project}/snapshots/restore', [CronogramaV2Controller::class, 'restoreSnapshot'])->name('proyectos.cronograma.v2.snapshots.restore');
