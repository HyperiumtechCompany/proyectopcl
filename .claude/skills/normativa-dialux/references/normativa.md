...
| iluminancia-exterior | **sin fuente cargada** | — | `v2/site/domain/exteriorLighting.ts` (modelo cos^n simplificado) | todos | No hay norma de iluminancia exterior (vías, estacionamientos, patios) en el proyecto. El modo Noche / mapa de lux del emplazamiento muestra lux estimados y uniformidad, pero NO valida cumplimiento ni cita un mínimo | no configurada | |
