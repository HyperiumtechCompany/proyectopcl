...
class FormalExportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'document.ambientDetails.*.dailyOperatingHours' => ['nullable', 'numeric', 'between:0,24'],
            'document.ambientDetails.*.minimumDailyOperatingHours' => ['nullable', 'numeric', 'between:0,24'],
            'document.ambientDetails.*.maximumDailyOperatingHours' => ['nullable', 'numeric', 'between:0,24'],
