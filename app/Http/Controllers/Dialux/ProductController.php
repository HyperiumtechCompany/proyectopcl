...
class ProductController extends Controller
{
    ...
    private function formatProduct(LuminaireProduct $product, bool $withWeb = false, ?int $userId = null): array
    {
        $data = [
            ...
            'product_image_url' => $product->product_image_path && Storage::disk('public')->exists($product->product_image_path)
                ? asset('storage/'.$product->product_image_path)
                : null,
            'brand_logo_path' => $product->brand_logo_path,
            'brand_logo_url' => $product->brand_logo_path && Storage::disk('public')->exists($product->brand_logo_path)
