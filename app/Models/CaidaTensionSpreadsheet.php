...
class CaidaTensionSpreadsheet extends Model
{
    ...
    {
        return $this->hasMany(CaidaTensionCollaborator::class, 'spreadsheet_id');
    }

    public function collaborators(): BelongsToMany
    {
        return $this->belongsToMany(User::class, 'caida_tension_collaborators', 'spreadsheet_id', 'user_id')
