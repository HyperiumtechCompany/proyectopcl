...
class DesagueCalculation extends Model
{
    ...
    {
        return $this->hasMany(DesagueCalculationCollaborator::class, 'desague_calculation_id');
    }

    public function collaborators(): BelongsToMany
    {
        return $this->belongsToMany(User::class, 'desague_calculation_collaborators', 'desague_calculation_id', 'user_id')
